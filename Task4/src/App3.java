...
public class App3 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print("\nПерейти к уточнению по Рунге-Ромбергу? (1 / 0 ): ");
            ...
            if (rungeChoice == 1) {
                ...
                System.out.printf("  %-18s   %-12s   %-12s   %-12s   %-12s   %-12s   %-12s  \n", 
                        "Метод (СКФ)", "J(h)", "|J - J(h)|", "J(h/l)", "|J - J(h/l)|", "Jp (уточн.)", "|J - Jp|");
                ...
                // Анализ результатов
                System.out.println("\nАнализ результатов");
                System.out.printf("При увеличении числа разбиений в %d раз (m=%d -> m=%d), погрешность всех методов уменьшилась.\n", l, m, mNew);
                System.out.println("Уточнение по Рунге (Jp) дало значение, наиболее близкое к точному интегралу J.");
                
                // Проверка на прочность (анализ для многочленов)
                if (funcNumber == 0) {
                    System.out.println("Тест на константе: Все методы, включая левые и правые прямоугольники, дали точный результат (погрешность ~ 0).");
                } else if (funcNumber == 1) {
                    System.out.println("Тест на линейной функции: Средние прямоугольники, трапеции и Симпсон дали точный результат (погрешность ~ 0).");
                } else if (funcNumber == 2 || funcNumber == 3) {
                    System.out.println("Тест на квадратичной/кубической функции: Формула Симпсона показала машинную точность (погрешность ~ 0), так как она точна для многочленов до 3-й степени включительно.");
                }
            }
